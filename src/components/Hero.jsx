  ...
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between h-screen">
      ...
      <div className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
        {/* Tag */}
        <div className="relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#e99b63] shadow-[0_0_15px_rgba(225,225,0.4)] rounded-full">
      ...
      <Spline
        ...
        scene="https://prod.spline.design/rdoBT1cS1atsBOe5/scene.splinecode"
      />
    </main>
  );
};
